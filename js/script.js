...
function setClock(selector, endtime) {
    ...
    function updateClock() {
        ...
        promotion.innerHTML = `Я ценю каждого клиента и предлагаю вам стать одним из них на очень выгодных условиях. Каждому, кто оформит заказ, будет предоставлена скидка в размере <span>30%!</span><br><br>Акция закончится ${endtime.split(`/`)[2]} Февраля в 00:00`;
...
const WorksPathItemPayment = document.querySelector('.works-path__item--payment'),
      ...
      СatalogCopmputerTab = document.querySelector ("[href='#pc-tab']") ;
...
if(main_with <= 768) {
    ...
    СatalogCopmputerTab.innerHTML = "Ремонт ПК";
}
